...
os.environ['LD_LIBRARY_PATH'] = '/home/nlbutts/projects/ml/armnn'
...
class Yolov8TFLite:
    ...
    def preload(self):
        ...
        if self.use_edgetpu:
            ...
            delegate = tflite.load_delegate('libarmnnDelegate.so', options={"backends": "CpuAcc, CpuRef ", "logging-severity": "fatal"})
            self.interpreter = tflite.Interpreter(model_path=self.tflite_model,
